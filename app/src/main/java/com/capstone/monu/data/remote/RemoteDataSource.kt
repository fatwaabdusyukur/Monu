...
class RemoteDataSource {
    ...
    fun getFoods(ingredient : String) : LiveData<ApiResponse<List<FoodList>>> {
        val client = ApiConfig.getApiServices().getRandomFood(TYPE_REQUEST, ingredient, API_ID, API_KEY)
